module StanfordNlpMethods
  ...
  def get_stanford_response(content,action_item_id)
    ...
    full_response = get_features(response,action_item_id)
    puts full_response
    #puts "PPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPP"
    #puts full_response
    ...
    scores = []
    puts "======================================================================="
    ActionItem.all.find_each do |action_item|
      next if action_item.id == self.id
